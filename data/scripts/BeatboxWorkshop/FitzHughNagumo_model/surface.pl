...
1                       show_sufrace
2, 0.999                ulayer, uc: surface layer and constant
0, 0.25, 0.50           vlayer, vmin, vmax: red-colour layer and range
1, 0.0, 1.0             wlayer, wmin, wmax: blue-colour layer and range
4,0.3,0.5               color_mode, alphamin, alphamax
