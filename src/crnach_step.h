...
/* computed quantities */
  ...
  acha = 10.0/(1.0 + 9.13652/pow(ach,0.477811));
  achb = 0.0517 + 0.4561/(1.0 + exp((V+59.53)/17.18));
  ikach = Cm*ikach_scale*acha*achb*(V - Ek);

  /* update membrane voltage */
  V = V - dt*(ina+icaL+icap+ik1+ito+ikur+ikr+iks+ibna+ibk+ibca+inak+inaca+ikach)/Cm;
