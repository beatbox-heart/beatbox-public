...
_(h,	1,	"CH relative success of larvae hunting",	    1)
_(n,	0.67,	"CH a larval metabolic constant",		    1)
_(alpCH,0.40,	"CH fraction of larvae food lost in metabolism",    1)
_(j,	0.002,	"CH a constant",				    1)
_(betmax,0.8,	"CH larvae maximal digestive coefficient",	    1)
_(betmin,0.225,	"CH larvae minimal (initial) digestive coefficient",1)
_(Gmax,	0.12,	"CH larvae maximal daily growth rate",		    1)

/* Suggested weight-dependence of larvae grazing intensity */
_(appwgt, 33,	"CH larvae maximal daily growth rate - reference wgt", ug)
_(appexp, 0 /*0.25*/,	"CH larvae maximal daily growth rate - decrease exp", 1)
