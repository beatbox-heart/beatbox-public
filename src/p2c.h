...
#if (defined(__STDC__) /* && !defined(M_XENIX) */ ) || defined(__TURBOC__) || defined(unix)
# include <stddef.h>
# include <stdlib.h>
# define HAS_STDLIB
...
/*#ifdef __TURBOC__*/
extern void  GetTime(unsigned short *hour,unsigned short *minute,unsigned short *second,unsigned short *sec100);
extern unsigned long DiskFree(unsigned char drive);
extern int ReadKey(void);
extern void assign(FILE *f, char *name);
extern void erase(FILE *f);
/*#endif*/
