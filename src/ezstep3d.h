...
/* 3D 7-point Laplacian formula */
#define ADD_TO_U_SUM7(index,index_2)            \
{ 						\
...
#define ADD_TO_V_SUM7(index,index_2)            	\
{						\
...
/* 3D 19-point Laplacian formula */
#define ADD_TO_U_SUM19(index,index_2)		\
{						\
  real stupid_cc = u[index];			\
...
#define ADD_TO_V_SUM19(index,index_2)		\
{						\
  real stupid_cc = v[index];			\
...
#if MANYPOINT	/* 19-point Laplacian formula */
  #define ADD_TO_U_SUM(index,index_2) ADD_TO_U_SUM19(index,index_2)
#else		/* 7-point Laplacian formula */
  #define ADD_TO_U_SUM(index,index_2) ADD_TO_U_SUM7(index,index_2)
#endif         
...
#else		/* v is diffusing */
#if MANYPOINT 	/* 19-point Laplacian formula */
  #define ADD_TO_V_SUM(index,index_2) ADD_TO_V_SUM19(index,index_2)
#else		/* 7-point Laplacian formula */
  #define ADD_TO_V_SUM(index,index_2) ADD_TO_V_SUM7(index,index_2) 
#endif 
#endif
